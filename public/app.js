            ...
            <div class="card" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 20px; border: 1px dashed var(--slate-200);">
                <div style="display: flex; align-items: center; gap: 15px;">
                    <div style="display: flex; flex-direction: column; gap: 4px;">
                        <button onclick="moveQuestion(${idx}, -1)" ${isFirst ? 'disabled style="opacity: 0.2; cursor: default;"' : 'style="cursor: pointer;"'} class="btn-move"><i class="fa-solid fa-chevron-up"></i></button>
                        <button onclick="moveQuestion(${idx}, 1)" ${isLast ? 'disabled style="opacity: 0.2; cursor: default;"' : 'style="cursor: pointer;"'} class="btn-move"><i class="fa-solid fa-chevron-down"></i></button>
                    </div>
                    <div>
